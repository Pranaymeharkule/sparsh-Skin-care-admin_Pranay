...
const ExportExcelIcon = (props) => {
  return (
    <svg
      {...props} // Allows use of className, style, onClick, etc.
      width="24"
      height="24"
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      <g clipPath="url(#clip0_3566_1523)">
        <g mask="url(#mask0_3566_1523)">
          <path
