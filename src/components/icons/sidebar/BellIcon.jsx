...
const BellIcon = (props) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#clip0_4905_3454)">
      <mask
        id="mask0_4905_3454"
        style={{
          maskType: "luminance",
      ...
      <g mask="url(#mask0_4905_3454)">
        ...
        />
        <path
          d="M20.7215 17.75H3.27148C2.86148 17.75 2.52148 17.41 2.52148 17V13C2.52148 8.9 5.43148 5.3 9.43148 4.45C10.0215 4.32 10.6415 4.25 11.2715 4.25H12.7215C13.3615 4.25 13.9815 4.32 14.5715 4.45C18.5715 5.31 21.4715 8.91 21.4715 13V17C21.4715 17.41 21.1415 17.75 20.7215 17.75ZM4.02148 16.25H19.9715V13C19.9715 9.61 17.5715 6.63 14.2515 5.91C13.7615 5.8 13.2515 5.75 12.7215 5.75H11.2715C10.7515 5.75 10.2415 5.8 9.75148 5.91C6.43148 6.62 4.02148 9.6 4.02148 13V16.25Z"
          fill="#7F7D7D"
        />
        <path
