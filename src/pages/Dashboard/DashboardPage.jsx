  ...
  return (
    <div className="min-h-screen overflow-y-scroll  flex items-center justify-center  px-4">
      <div className="bg-gradient-to-br from-orange-100 to-pink-100 backdrop-blur-lg p-8 rounded-2xl shadow-xl w-full max-w-md">
        <h2 className="text-2xl font-bold text-center">Sparsh Skin Care Admin</h2>
        <p className="text-center text-gray-500 text-sm mb-6">Security Administration Access</p>

        <form className="space-y-4">
          {/* Email */}
          <div>
            <label className="block tex  text-start font-medium text-gray-700">Email Address</label>
            <input
              type="email"
          ...
          {/* Role Selection */}
          <div>
            <label className="block text-  text-start font-medium text-gray-700 mb-1">Access Role</label>
